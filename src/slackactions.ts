...
export function init(): void {
    ...
    Slack.addActionHandler({ actionId: TurnManager.LOL_ACTION }, PlayerVotes.handleLol);
    Slack.addActionHandler({ actionId: TurnManager.VOTE_ACTION }, PlayerVotes.handleVoteButton);
